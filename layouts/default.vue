            ...
            <div class="row">
                <div class="column col-12">
                    <NuxtLink class="logo" to="/">
                        <svg id="logo" x="0px" y="0px" viewBox="0 0 432.82 84.18">
                        <g>
                    ...
                    <a href="https://forms.gle/etM7UPrGLXdm6bU79" class="email" target="_blank">send your <span>music<img src="~/assets/images/svg/send_music.svg" alt=""></span></a>
                </div>
